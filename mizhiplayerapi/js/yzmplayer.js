		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					), t += '\n</div>\n<div class="yzmplayer-menu">\n    ', t += '<div class="yzmplayer-menu-item"> <a href="javascript:void(0);">视频统计信息</a> </div> <div class="yzmplayer-menu-item"> <a href="https://www.98dou.cn" target="_blank">觅知博客</a> </div>', t +=
					...
					return o(e, [{
						...
						value: function() {
							...
							t = this.options.api.maximum ? this.options.api.address + "&id=" + this.options.api.id + "&max=" + this.options
								.api.maximum : this.options.api.address + "&url=" + urls;
