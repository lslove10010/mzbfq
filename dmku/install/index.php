...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_POST['dbtype'] == 3 or $_POST['dbtype'] == 4) {
        ...
        session_destroy();
        die("安装成功，请访问你的域名/admin进入后台！解析地址你的域名/player/?url=");
    }
        ...
        <div>
            <h2>数据库配置</h2>
				<div class="form-group">
                    ...
                    <p class="help-block">请根据您的数据库类型选择合适的适配器(列出来的都是服务器支持的)</p>
				</div>
                <div id="mysql">                    
                    <div class="form-group">
                        <label>数据库地址</label>
                        <input type="text"  class="form-control" name="host" value="localhost">
                        <p class="help-block">您可能会使用 "localhost"</p>
                    </div>                   
                    <div class="form-group">
                        <label>数据库用户名</label>
                        <input type="text"  class="form-control" name="user" value="root">
                        <p class="help-block">您可能会使用 "root"</p>
                    </div>
                    <div class="form-group">
                        <label>数据库密码</label>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block">请您指定数据库名称</p>  
                    </div>                    
                </div>
            <script>
